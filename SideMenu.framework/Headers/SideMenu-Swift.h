...
SWIFT_CLASS("_TtC8SideMenu23BasicTransitionAnimator")
...
@property (nonatomic, copy) NSString * _Nonnull contentSegueID;
/// The identifier of menu view controller segue.
/// If the SideMenuController instance is initiated from IB, this identifier will
/// be used to retrieve the menu view controller.
@property (nonatomic, copy) NSString * _Nonnull menuSegueID;
- (void)viewDidLoad;
...
@interface SideMenuController (SWIFT_EXTENSION(SideMenu)) <UIGestureRecognizerDelegate>
...
SWIFT_CLASS("_TtC8SideMenu13SideMenuSegue")
@interface SideMenuSegue : UIStoryboardSegue
/// Peforming the segue, will change the corresponding view controller of side menu to <code>destination</code> vew controller.
