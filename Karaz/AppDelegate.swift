...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplication.LaunchOptionsKey: Any]?) -> Bool {
        ...
        if  UserDefaultValue.getUserDefault(key: validUser) == "xxxxx" {
            //Login Suucess Skip for the login screen.
            //and go to main screen.
            let dashboard = UIStoryboard(name: "Main", bundle: nil).instantiateViewController(withIdentifier: "SideMenu")
